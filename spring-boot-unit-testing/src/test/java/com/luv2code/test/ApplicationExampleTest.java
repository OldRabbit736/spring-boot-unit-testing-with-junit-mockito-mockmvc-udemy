...
public class ApplicationExampleTest {
    ...
    @Autowired
    CollegeStudent student; // prototype bean
    ...
    public void beforeEach() {
        ...
        // student 는 prototype bean 이기 때문에 각 테스트가 시작될 때마다 새로운 객체로 교환되는 듯 하다.
    ...
    public void createStudentWithoutGradesInit() {
        ...
        studentTwo.setEmailAddress("chad.darby@abc.com");
    ...
    public void verifyStudentsArePrototypes() {
        ...
        // prototype bean 은 외부 요청 마다 새롭게 만들어진다.
